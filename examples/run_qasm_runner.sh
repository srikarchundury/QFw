...
QASM_PREPEND_PATH="/lustre/orion/gen006/proj-shared/qhpc/srikar/qfw_related/applications/dr_kim_qaoa/qaoa20_data/"
...
qfw_srun.sh "\$QFW_PATH/../applications/qasm_runner/qfw_qasm_runner.py" $QASM_FILE $N_QUBITS $SIM_QRC $SUB_BACKEND $DEVICE $RUN_MODE $N_ITRS
