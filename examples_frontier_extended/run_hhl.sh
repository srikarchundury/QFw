...
# ------------------ Validations ------------------
# TODO:validate QASM_FILE exists and is readable, and that N_QUBITS is a positive integer
valid_sim_types=("nwqsim" "qiskitaer" "tnqvm" "qtensor" "ionq")
...
#SBATCH --output=${RESULT_DIR}/hhl_data/_${QASM_FILE}_${N_QUBITS}_${SIM_QRC}_${SUB_BACKEND}_${DEVICE}_${RUN_MODE}_${N_NODES}_${N_PROCESSES_PER_NODE}_${N_ITRS}_%j.out
...
qfw_srun.sh "\$QFW_PATH/../applications/hhl/qfw_hhl.py" $QASM_FILE $N_QUBITS $SIM_QRC $SUB_BACKEND $DEVICE $RUN_MODE $N_ITRS
