...
SERVICE_NAME = "QPM"
SERVICE_DESC = "Quantum Platform Manager for IONQ"
...
def qpm_complete_init():
    ...
    logging.debug("IonQ QPM initialized successfully")


def qpm_wait_resmgr():
    while not defw.resmgr and not uq.qpm_shutdown:
        logging.debug("IonQ QPM waiting for resmgr...")
...
def uninitialize():
    ...
    logging.debug("IonQ QPM shutdown called")
